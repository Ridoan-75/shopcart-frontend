// src/app/(dashboard)/seller/inventory/page.tsx
"use client";
...
export default function SellerInventoryPage() {
  ...
  const { data, isLoading } = useQuery({
    queryKey: [QUERY_KEYS.PRODUCTS, "seller-inventory", search, filter, page],
    queryFn: () =>
      axiosInstance
        .get("/seller/products", {
          params: {
  ...
  const updateMutation = useMutation({
    mutationFn: ({ id, payload }: { id: string; payload: UpdateForm }) =>
      axiosInstance.patch(`/seller/products/${id}/inventory`, payload),
    onSuccess: () => {
      qc.invalidateQueries({
        queryKey: [QUERY_KEYS.PRODUCTS, "seller-inventory"],
      });
  ...
  const handleUpdate = () => {
    ...
    if (editForm.lowStockAlert < 0)
      return toast.error("Low stock alert cannot be negative");
      ...
      <div className="flex items-center gap-3 mb-5">
        ...
        <div className="relative">
          <button
            ...
            style={{ ...INPUT_STYLE, minWidth: "150px" }}
          >
